...
export default function Home() {
     ...
     <div className="flex flex-row w-screen h-5/6 items-center justify-start gap-10 p-10 ">
       <div className="flex flex-col w-1/2 h-1/2  items-center justify-center border border-blue-100 rounded-md gap-6">
         <div className="flex flex-col items-start justify-start p-10 gap-4">
           ...
           <br></br>
           <p className="text-black text-lg tracking-normal leading-10">Conversations across languages often hit roadblocks,
            leading to misunderstandings and hindering effective communication. 
            At TRANSCEND, we believe in making language no longer a barrier in conversations. 
            Introducing our groundbreaking solution: a comprehensive real-time language translation software.</p>
         </div>
       </div>
 ...
 <div className="flex flex-grow h-1/6 justify-center items-center pb-5 "> 
     <button onClick={() => router.push("/meetingpage")}className=" box-content p-4 border-4 bg-[#2096BD]    rounded-xl py-4 px-9 font-semibold  ">
       New Meeting
     ...
     <div className="h-screen bg-white">
      <div className="flex flex-col md:flex-row h-1/6 bg-white mt-10 md:pt-0"> 
        <div className="flex justify-center items-center h-full w-full md:w-1/2">
            <h1 className="text-xl rounded-2xl p-3 text-black font-extrabold px-4 border-4 border-solid border-[#B4D4FF]">Facilitating Inclusive Communication</h1>
        </div>
        <div className="flex justify-center items-center h-full w-full md:w-1/2">
            <h1 className="text-xl rounded-2xl p-3 text-black font-extrabold px-10 border-4 border-solid border-[#B4D4FF]">Innovative Technology</h1>
        </div>
    </div>
    <div className="flex items-center justify-center h-4/6 bg-white">
        <img className="h-1/2" src="subtitle 1.svg" alt="Description of the image" />        
    </div>
    
{/**footer */}
    <div className="h-1/6 bg-[#B4D4FF]">
    </div>
 {/**footer */}
