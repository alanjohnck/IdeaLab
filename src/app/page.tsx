        ...
        <div className="flex flex-row w-screen h-full items-center justify-start gap-2 p-6 ">
          <div className="flex flex-col w-1/2 h-2/3 items-center justify-center border border-blue-100 rounded-md">
            <div className="flex flex-col items-start justify-start p-5">
              <h1 className="flex justify-start  text-blue-300  text-2xl font-extrabold">
                Breaking Language Barriers with Real-Time Translation
              </h1>
              <br></br>
              <p className="text-black text-lg font-regular">
                Conversations across languages often hit roadblocks, leading to
                misunderstandings and hindering effective communication. At
                TRANSCEND, we believe in making language no longer a barrier in
                conversations. Introducing our groundbreaking solution: a
